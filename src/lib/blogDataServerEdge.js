/**
 * Données blog pour le runtime Edge (Cloudflare) — D1 uniquement.
 * Utilisé par les pages /blog et /blog/[slug] en runtime Edge.
 */
import { blogArticles, blogList, loadContentArticles } from "./blogStorageD1";
